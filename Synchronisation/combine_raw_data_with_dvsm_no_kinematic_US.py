...
if __name__ == "__main__":
    ...
    output_path = 'E:\FFOutput\SyncedWithTimestamps_1'
    ...
    video_csv_0_path = 'E:\FFOutput\EndoscopeImageMemory_0.csv'
    ...
    video_csv_1_path = 'E:\FFOutput\EndoscopeImageMemory_1.csv'
    ...
    start_time = timestamps_1[start_frame]
    # end_time = min(timestamps_0[len(timestamps_0) - 1], timestamps_1[len(timestamps_1) - 1])
    if end_frame >= timestamps_1.size:
        end_frame = timestamps_1.size-1

    end_time = timestamps_1[end_frame]
    ...
    print('Done!')
    print('frames_0[0], frames_1[0] = {},{}'.format(frames_0[0], frames_1[0]))
    print('frames_0[total_frames-1], frames_1[total_frames-1] = {},{}'.format(
       frames_0[total_frames-1], frames_1[total_frames-1]))
    ...
    print('frames_0[100], frames_1[100] = {},{}'.format(frames_0[100], frames_1[100]))
    ...
    for i in range(total_frames):
        ...
        print('Processing frame {} out of {} - target frames are {} and {}'.format(i + 1, total_frames, target_frame_index_0, target_frame_index_1), end='\n')
