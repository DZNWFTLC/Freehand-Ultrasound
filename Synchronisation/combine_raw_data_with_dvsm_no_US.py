...
if __name__ == "__main__":
    ...
    output_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\SyncedWithTimestamps'
    ...
    video_0_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\EndoscopeImageMemory_0_de.avi'
    #video_1_path = path.join(r'EndoscopeImageMemory_1.avi')
    #video_1_path = path.join(basedir,r'EndoscopeImageMemory_1_deint.avi')
    video_1_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\EndoscopeImageMemory_1_de.avi'
    ...
    video_csv_0_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\EndoscopeImageMemory_0.csv'
    ...
    video_csv_1_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\EndoscopeImageMemory_1.csv'
    #kinematics_csv_path = path.join(r'DaVinciSiMemory.csv')
    kinematics_csv_path = 'D:\Data\Log_D2P282649_2019.08.13_13.32.59\part0002\DaVinciSiMemory.csv'
    ...
    # video_1_path = 'E:\\Software\\UCL\\daVinci\\MatLabScripts\\Data\\KnotTying\\Expert\\Log_D1P280782_2017.08.30_16.39.01_part0012\\EndoscopeImageMemory_1_768_576.avi'
    ...
    start_time = timestamps_0[start_frame]
    # end_time = min(timestamps_0[len(timestamps_0) - 1], timestamps_1[len(timestamps_1) - 1])
    if end_frame >= timestamps_0.size:
        end_frame = timestamps_0.size-1

    end_time = timestamps_0[end_frame]
